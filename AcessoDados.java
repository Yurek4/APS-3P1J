...
//
        try (   InputStream is = new FileInputStream(filePath);
            ...
            while((linha = br.readLine()) != null){
                ...
                String nomedocarro = palavras[0];
                String modelo = palavras[1];
                int ano = Integer.parseInt(palavras[2]);
                double preco = Double.parseDouble(palavras[3]);

                Carro carro1 = new Carro(nomedocarro, modelo, ano, preco);
                Carros.add(carro1);
    ...
    public static void saveCarros(List<Carro> carros, String filePath){
        ...
        try(    OutputStream os = new FileOutputStream(filePath/*, true*/);
            ...
            for(Carro carro: carros){
                pw.println(carro.getNomedocarro()+","+carro.getModelo()+","+carro.getAno()+","+carro.getPreco());
            }
